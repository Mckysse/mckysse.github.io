...
- **LLM Reasoning, Uncertainty & Benchmark Evaluation:**  
  I study how LLMs reason, how Chain-of-Thought (CoT) affects their predictions, and how reasoning traces can be evaluated beyond final-answer accuracy. Recent work investigates CoT mechanisms and uncertainty through human judgment distributions ([Chen et al., 2025b](https://aclanthology.org/2025.emnlp-main.1682/); [Chen et al., 2026a](https://arxiv.org/abs/2601.03154)), as well as how CoT traces transfer across models under controlled provider--receiver settings ([Cheng and Chen et al., 2026](https://arxiv.org/abs/2605.28913)). I am also interested in robust benchmark design, aggregation-based metrics, LLM-as-a-judge evaluation, and trustworthy comparison of frontier models.

- **Human-centered NLP, Human Label Variation & Explanation-based Alignment:**  
  I study human label variation as a meaningful signal rather than noise, focusing on how annotators differ in labels, explanations, and reasoning patterns. My work decomposes annotation disagreement through labels and explanations ([Hong and Chen et al., 2026](https://arxiv.org/abs/2510.16458)), explores explanation-based alignment and within-label variation ([Chen et al., 2025a](https://aclanthology.org/2025.findings-acl.562/); [Hong and Chen et al., 2025](https://aclanthology.org/2025.emnlp-main.1728/)), and investigates whether LLMs can learn annotator-specific label-explanation behavior via reinforcement learning ([Chen et al., 2026b](https://arxiv.org/abs/2605.28802)). Earlier work also explored human-inspired pre-training strategies ([Chen et al., 2023](https://aclanthology.org/2023.findings-acl.9/)).

- **Multilingualism, Cross-lingual Transfer & Cultural Evaluation:**  
  I work on multilingual NLP and cross-lingual generalization, including cross-lingual transfer ([Ma and Chen et al., 2022](https://aclanthology.org/2022.emnlp-main.345/); [Chen et al., 2022c](https://ieeexplore.ieee.org/document/9956721)), cross-lingual post-training ([Chen et al., 2022a](https://ieeexplore.ieee.org/document/9747720)), and multilingual adaptation for shared tasks ([Chen et al., 2022b](https://aclanthology.org/2022.semeval-1.223/)). More recently, I have contributed to scalable evaluation frameworks for multilingual and cultural awareness in LLMs ([Zhao et al., 2025](https://aclanthology.org/2025.findings-emnlp.1256/)).
